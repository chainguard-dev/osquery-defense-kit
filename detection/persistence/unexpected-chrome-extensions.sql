...
WHERE
  ...
  AND NOT exception_key IN (
    ...
    'true,,Salesforce Inspector Reloaded,hpijlohoihegkfehhibggnkbjhoemldh',
    ...
    'true,,Free VPN for Chrome - VPN Proxy VeePN,majdfhpaihoncoakbjgbdhglocklcgno',
    ...
    'true,,Record and Metadata Comparator for Salesforce,laghgcpekjofijkmojnhfeiplbffaljp',
    'true,,Tamper Chrome (extension),hifhgpdkfodlpnlmlnmhchnkepplebkb',
    'true,,Screen Recorder,hniebljpgcogalllopnjokppmgbhaden',
    'true,,Perplexity - AI Search,bnaffjbjpgiagpondjlnneblepbdchol',
