  ...
  AND NOT (
    ...
    AND (
      exception_key IN (
        ...
        'atd.service,Deferred execution scheduler,,200',
        ...
        "blockdev@dev-mapper-cryptdata.target,Block Device Preparation for /dev/mapper/cryptdata,,400",
        'blockdev@dev-mapper-cryptoswap.target,Block Device Preparation for /dev/mapper/cryptoswap,,400',
        "blockdev@dev-mapper-cryptswap.target,Block Device Preparation for /dev/mapper/cryptswap,,400",
        'blueman-mechanism.service,Bluetooth management mechanism,,100',
        ...
        "com.system76.PowerDaemon.service,System76 Power Daemon,,200",
        "com.system76.Scheduler.service,Automatically configure CPU scheduler for responsiveness on AC,,200",
        'console-setup.service,Set console font and keymap,,300',
        'containerd.service,containerd container runtime,,1200',
        'crond.service,Command Scheduler,,300',
        ...
        "dbus-:1.2-org.pop_os.transition_system@0.service,dbus-:1.2-org.pop_os.transition_system@0.service,0,200",
        ...
        "finalrd.service,Create final runtime dir for shutdown pivot root,,400",
        ...
        "ifupdown-pre.service,Helper to synchronize boot up for ifupdown,,400",
        ...
        'iwd.service,Wireless service,,600',
        ...
        'lm_sensors.service,Hardware Monitoring Sensors,,400',
        ...
        'mlocate-updatedb.timer,Updates mlocate database every day,,100',
        ...
        'monitorix.service,Monitorix,,300',
        ...
        'pwrstatd.service,The monitor UPS software.,,200',
        ...
        "resolvconf-pull-resolved.path,resolvconf-pull-resolved.path,,100",
        "resolvconf.service,Nameserver information manager,,300",
        'resolvconf.service,resolvconf update,,1100',
        'rngd.service,Hardware RNG Entropy Gatherer Daemon,,300',
        ...
        'sshd.service,OpenSSH server daemon,,300',
        ...
        'systemd-binfmt.service,Set Up Additional Binary Formats,,1100',
        ...
        "systemd-cryptsetup@cryptswap.service,Cryptography Setup for cryptswap,,1100",
        ...
        'systemd-journald.service,Journal Service,,2000',
        ...
        'systemd-network-generator.service,Generate network units from Kernel command line,,700',
        ...
        'systemd-sysusers.service,Create System Users,,1200',
