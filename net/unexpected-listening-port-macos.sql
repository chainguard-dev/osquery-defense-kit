...
CONCAT(MIN(lp.port, 32768), "/", lp.protocol, "/", MIN(p.uid, 500), "/", p.name, "/", signature.authority) AS exception_key
...
WHERE port != 0
    ...
    AND NOT CONCAT(MIN(lp.port, 32768), "/", lp.protocol, "/", MIN(p.uid, 500), "/", p.name, "/", signature.authority) IN (
        ...
        '32768/6/500/rapportd/Software Signing',
        '6000/6/500/X11.bin/Developer ID Application: Apple Inc. - XQuartz (NA574AWV7E)',
        '32768/6/500/com.docker.backend/Developer ID Application: Docker Inc (9BNSXJN65R)',
        '32768/6/500/IPNExtension/Apple Mac OS Application Signing',
        '32768/6/500/vpnkit-bridge/Developer ID Application: Docker Inc (9BNSXJN65R)',
        '631/6/0/cupsd/Software Signing',
        '16587/6/500/RescueTime/Developer ID Application: RescueTime, Inc (FSY4RB8H39)',
        '32768/6/500/Spotify/Developer ID Application: Spotify (2FNC3A47ZF)',
        ...
        '32768/6/0/remoted/Software Signing',
        '32768/6/74/mysqld/Developer ID Application: Oracle America, Inc. (VB5E2TV963)',
        ...
        '32768/6/0/launchd/Software Signing',
        '32768/6/0/remotepairingdeviced/Software Signing',
        '3306/6/500/mariadbd/'
    )
